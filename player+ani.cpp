...
void player::allplayerimage()
{
	...
	_player._playerimg = IMAGEMANAGER->addFrameImage("인벤용던전캐릭터", "images/player/will_dungeon.bmp", 2600, 1580, 10, 13, true, RGB(255, 0, 255)); //던전캐릭턱
	...
	IMAGEMANAGER->addImage("플레이어체력바앞", "images/UI/blood.bmp", 125, 35, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("플레이어체력바뒤", "images/UI/hpBar.bmp", 125, 35, true, RGB(255, 0, 255));
