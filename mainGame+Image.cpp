...
void mainGame::imagesInit()
{
	...
	IMAGEMANAGER->addFrameImage("골렘폭발", "images/monster/golemBomb.bmp", 2022 * 3, 144 * 3, 16, 1, true, RGB(255, 0, 255));
	ANIMATIONMANAGER->addAnimation("폭발", "골렘폭발", 0, 15, 16, false, false);
