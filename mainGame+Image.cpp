...
void mainGame::imagesInit()
{
	...
	ANIMATIONMANAGER->addAnimation("골렘보스공격1B", "골렘보스", 0, 14, 8, false, false);
	ANIMATIONMANAGER->addAnimation("골렘보스공격1L", "골렘보스", 15, 29, 8, false, false);
	ANIMATIONMANAGER->addAnimation("골렘보스공격1R", "골렘보스", 30, 44, 8, false, false);
	ANIMATIONMANAGER->addAnimation("골렘보스공격1U", "골렘보스", 45, 59, 8, false, false);
	ANIMATIONMANAGER->addAnimation("골렘보스공격2B", "골렘보스", 120, 134, 8, false, false);
	ANIMATIONMANAGER->addAnimation("골렘보스공격2L", "골렘보스", 135, 149, 8, false, false);
	ANIMATIONMANAGER->addAnimation("골렘보스공격2R", "골렘보스", 150, 165, 8, false, false);
	ANIMATIONMANAGER->addAnimation("골렘보스공격2U", "골렘보스", 165, 179, 8, false, false);
