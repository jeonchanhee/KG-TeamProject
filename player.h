...
private:
	...
	inventory* _inventory;						//인	벤토리

	RECT _swordrect[4];							//칼공격시 공격용 렉트
...
public:
	...
	PLAYERMOVING getPlayerMoveing() { return _player._playermove; }
	void setPlayerMoving(PLAYERMOVING playerMoving) { _player._playermove = playerMoving; }
};