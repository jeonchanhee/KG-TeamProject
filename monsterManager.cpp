...
void monsterManager::setMinion2()
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		golemTurret->init("골렘터렛", MONSTER_TYPE_GOLEMTURRET, MONSTER_STATE_ATK, MONSTER_DIRECTION_LEFT, 700, 100 + i * 200, 10, 100, 100, 50, 0);
...
void monsterManager::setMinion4()
{
	...
	golemBoss->init("골렘보스", MONSTER_TYPE_GOLEMBOSS, MONSTER_STATE_MOVE, MONSTER_DIRECTION_DOWN, 500, 500, 10, 100, 100, 50, 5);
